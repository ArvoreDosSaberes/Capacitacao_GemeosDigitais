![header](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Video%20Aulas%20no%20YouTube&fontSize=50&fontAlignY=35&animation=twinkling)

![visitors](https://visitor-badge.laobi.icu/badge?page_id=ArvoreDosSaberes.Capacitacao_GemeosDigitais.VIDEO_AULAS_NO_YOUTUBE)
...
# 🎥 Playlists de Video Aulas no YouTube

Este arquivo reúne as playlists de video aulas relacionadas ao curso de **Capacitação em Gêmeos Digitais e 5G** disponíveis no YouTube.
...
1. Acesse as playlists através dos links acima
2. Assista às aulas em ordem para melhor acompanhamento didático
3. Consulte os materiais complementares em cada módulo do repositório
4. Pratique com os notebooks e exercícios disponibilizados

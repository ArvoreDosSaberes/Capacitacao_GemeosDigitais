![header](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Windsurf%20Large%20Language%20Models%20(LLMs)&fontSize=40&fontAlignY=35&animation=twinkling)

# 🤖 Windsurf Large Language Models (LLMs) - Módulo de Capacitação
